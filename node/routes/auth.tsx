...
const AuthContnroller = require('../controllers/auth.tsx');
const {
    AccountType,
    CheckType,
    Address,
...
router.post('/signup', function(req, res){
  ...
  AuthContnroller.signup(req, res)
});

router.post('/login', function(req, res, next){

  AuthContnroller.login(req, res, next)
});
...
router.post('/GetCitizesByCID', function(req, res, next){
    ...
    AuthContnroller.GetCitizesByCID(req, res, next)
});
router.post('/GetCitizesBySID', function(req, res, next){

    AuthContnroller.GetCitizesBySID(req, res, next)
});

router.post('/PayoutspaypalPayment', function(req, res, next){
    ...
    paypal.payout.create(create_payout_json, function (error, payout) {
        ...
        {console.log(util.inspect(error, false, null));
            ...
            console.log(util.inspect(payout, false, null));
...
router.post('/braintreePayment', function(req, res, next) {
    ...
    var gateway = braintree.connect({
        ...
        merchantId: "ttkvf7g4v4p6xs9s",
        publicKey: "v3t4jbh52t34tfn4",
        privateKey: "c976e4c3eab7723926f3690b7f43b67a"
    });
  let customerId="";
    gateway.customer.create({
        ...
        gateway.creditCard.create(creditCardParams, function (err, response) {
            gateway.transaction.sale({
                    amount: '5.00',
                    paymentMethodNonce: response.creditCard.CreditCard,
                    options: {
