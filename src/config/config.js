...
{return 'https://one-drupal-demo2.technikh.com/onedrupal/api/v1/vocabulary/'+reactjs_blog_categorySetting+''}
export  const all_css_posts="https://one-drupal-demo2.technikh.com/onedrupal/api/v1/content/all/195";
export  const all_js_posts="https://one-drupal-demo2.technikh.com/onedrupal/api/v1/content/all/167";
