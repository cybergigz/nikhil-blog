...
export  const all_css_posts="https://one-drupal-demo.technikh.com/onedrupal/api/v1/content/all/17";
export  const all_js_posts="https://one-drupal-demo.technikh.com/onedrupal/api/v1/content/all/19";
